...
5.  [Install Shibboleth Identity Provider](#install-shibboleth-identity-provider)
6.  [Disable Jetty Directory Indexing](#disable-jetty-directory-indexing)
7.  [Configure Apache Web Server](#configure-apache-web-server)
8. [Configure Jetty Context Descriptor for IdP](#configure-jetty-context-descriptor-for-idp)
9. [Configure Apache2 as the front-end of Jetty](#configure-apache2-as-the-front-end-of-jetty)
...
26. [Appendix B: Useful logs to find problems](#appendix-c-useful-logs-to-find-problems)
27. [Appendix C: Connect an SP with the IdP](#appendix-d-connect-an-sp-with-the-idp)
